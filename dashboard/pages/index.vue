...
useHead({
  title: 'Port Kill - Dashboard',
  meta: [
    {
      name: 'description',
      content: 'Port Kill - Kill dev ports'
    },
    {
      name: 'keywords',
      content: 'port kill, process management, port monitoring, Docker, development tools, process killer, port conflicts, system monitoring, developer tools'
    },
    {
      name: 'robots',
